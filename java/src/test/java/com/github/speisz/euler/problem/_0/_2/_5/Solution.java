...
import static com.github.speisz.euler.utils.MathUtil.greaterThanOrEqualTo;
...
class Solution {
    ...
    void findsIndexOfFirstFibonacciWith1000Digits() {
        assertThat(indexedFibonaccis()
                .filter(pair -> greaterThanOrEqualTo(pair.getRight(), BigInteger.valueOf(10).pow(1000 - 1)))
                .findFirst()
