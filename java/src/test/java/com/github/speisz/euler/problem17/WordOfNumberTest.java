...
class WordOfNumberTest {
    @Test
    void getsWordsOfDigits() {
    ...
    @Test
    void getsRegularCombinedWordsUpToHundred() {
    ...
    @Test
    void getsWordsForExceptionalCases() {
